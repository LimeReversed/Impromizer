...
namespace Headline_Randomizer
{
    public partial class Form1 : Form
    {
        ...
        private void BtnGenerate2_Click(object sender, EventArgs e)
        {
            presentationWindow.tbxResult.Text = "";
            int liveNounNr = r.Next(0, list.liveNoun.Count);
            presentationWindow.tbxResult.AppendText($"Enligt {list.liveNoun[liveNounNr].Plural} ");
            list.liveNoun.RemoveAt(liveNounNr);
            ...
            presentationWindow.tbxResult.AppendText($"{list.verb[verbNr].Presens} {list.liveNoun[liveNounNr2].Plural} {(list.verb[verbNr].PostVerbs == "-" ? "" : $"{list.verb[verbNr].PostVerbs} ")}{list.deadNoun[deadNounNr].Plural}");
        ...
        private void btnGenerate6_Click(object sender, EventArgs e)
        {
            ...
            presentationWindow.tbxResult.AppendText($"Kom ihåg, {list.verb[verbNr].Request} alltid {(list.verb[verbNr].PostVerbs == "-" ? "" : $"{list.verb[verbNr].PostVerbs} ")}dina {list.liveNoun[liveNounNr].Plural}");
        ...
        private void btnGenerate7_Click(object sender, EventArgs e)
        {
            ...
            presentationWindow.tbxResult.AppendText($"Lycka är {list.adjective[adjectiveNr].Plural} {list.deadNoun[deadNounNr].Plural}");
    ...
    class Lists
    {
        ...
        public void LoadNeeded(int amount)
        {
            ...
            {
                StreamReader sr = new StreamReader("verb basform.txt");
                StreamReader sr2 = new StreamReader("verbs presens.txt");
                StreamReader sr3 = new StreamReader("verbs imperfekt.txt");
                StreamReader sr4 = new StreamReader("post verbs.txt");
                StreamReader sr5 = new StreamReader("verb request.txt");
            ...
            {
                StreamReader sr = new StreamReader("dödasubstantivsing.txt");
                StreamReader sr2 = new StreamReader("dödasubstantivplural.txt");
            ...
            {
                StreamReader sr = new StreamReader("levandesubstantivsing.txt");
                StreamReader sr2 = new StreamReader("levandesubstantivplural.txt");
            ...
            {
                StreamReader sr = new StreamReader("adjektivsingular.txt");
                StreamReader sr2 = new StreamReader("adjektivplural.txt");
                ...
                while ((fileRow = sr.ReadLine()) != null && ((fileRow2 = sr2.ReadLine()) != null))
                {
                    Adjectives vread = new Adjectives(fileRow, fileRow2);
                    adjective.Add(vread);
                }
                sr.Close();
                sr2.Close();
            ...
            {
                StreamReader sr = new StreamReader("jokenames2.txt");
            ...
            {
                StreamReader sr = new StreamReader("nobelprizes2.txt");
    ...
    abstract class SiPl : Book
    {
        ...
        public SiPl(string singular, string plural) : base()
        {
    ...
    class Adjectives : SiPl
    {
        ...
        public Adjectives(string singular, string plural) : base(singular, plural)
        {
        }
    }
